...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=00C2FF&size=25&center=true&vCenter=true&width=600&lines=QA+Analyst+%7C+Software+Quality;Testes+Manuais+%7C+Automação+%7C+Performance;Compartilhando+Conhecimento+para+QAs+🚀" />
</p>
...
```mermaid
flowchart LR
    A[Qualidade] --> B[Experiência do Usuário]
    A --> C[Performance]
    A --> D[Confiabilidade]
...
[![LinkedIn](https://img.shields.io/badge/Vamos_conectar!-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/felipefreitasgenitore/)
